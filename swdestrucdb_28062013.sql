...
ALTER TABLE g5dze
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5dze', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5dze_test
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5dze_test', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5jew
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5jew', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5jew_test
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5jew_test', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5kkl
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5kkl', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5obr
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5obr', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5obr_test
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5obr_test', 'geom', -1, 'POLYGON', 2);
...
ALTER TABLE g5uzg
  OWNER TO biuro;
SELECT AddGeometryColumn('public', 'g5uzg', 'geom', -1, 'POLYGON', 2);
